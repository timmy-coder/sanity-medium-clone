...
const onSubmit: SubmitHandler<IFormInput> = (data) => {
    ...
    return <main>
        ...
        {submitted ? (
        <div className="flex flex-col p-10 my-10 bg-yello-500 text-white max-w-2xl mx-auto">
            ...
            <label className="block mb-5">
                ...
                <input {...register("name", {required: true })} className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" type="text" placeholder="John Deo" />
                {errors.name && (
